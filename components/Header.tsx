...
const Header = ({ activeSection }: { activeSection: string | null }) => {
    ...
    return (
        <nav
            className={`fixed z-50 left-0  flex items-center justify-around w-full py-4 bg-gray-900 transition-all duration-500 ${
